...
object Notifications {
  ...
  case class WorkspaceAddedNotification(recipientUserId: WorkbenchUserId, accessLevel: String, workspaceName: WorkspaceName, workspaceOwnerId: WorkbenchUserId) extends UserNotification
  ...
  case class WorkspaceRemovedNotification(recipientUserId: WorkbenchUserId, accessLevel: String, workspaceName: WorkspaceName, workspaceOwnerId: WorkbenchUserId) extends UserNotification
  ...
  case class WorkspaceInvitedNotification(recipientUserEmail: WorkbenchEmail, requesterId: WorkbenchUserId, workspaceName: WorkspaceName, bucketName: String) extends Notification
  ...
  case class WorkspaceChangedNotification(recipientUserId: WorkbenchUserId, workspaceName: WorkspaceName) extends WorkspaceNotification
  ...
  case class GroupAccessRequestNotification(recipientUserId: WorkbenchUserId, groupName: String, replyToIds: Set[WorkbenchUserId], requesterId: WorkbenchUserId) extends Notification

...
class TelemeterizedHttpGoogleDirectoryDAO(appName: String,
  ...
  override def createGroup(displayName: String, groupEmail: WorkbenchEmail, groupSettings: Option[GroupSettings]): Future[Unit] = {
    super.createGroup(displayName, groupEmail, groupSettings)
      .andThen {
  ...
  override def deleteGroup(groupEmail: WorkbenchEmail): Future[Unit] = {
    super.deleteGroup(groupEmail: WorkbenchEmail)
      .andThen {
  ...
  override def addMemberToGroup(groupEmail: WorkbenchEmail, memberEmail: WorkbenchEmail): Future[Unit] = {
    super.addMemberToGroup(groupEmail: WorkbenchEmail, memberEmail: WorkbenchEmail)
      .andThen {
  ...
  override def addServiceAccountToGroup(groupEmail: WorkbenchEmail, serviceAccount: ServiceAccount): Future[Unit] = {
    super.addServiceAccountToGroup(groupEmail: WorkbenchEmail, serviceAccount: ServiceAccount)
      .andThen {
        case Failure(_) => openTelemetry.incrementCounter("addServiceAccountToGoogleGroupFailure", tags = openTelemetryTags)
        case Success(_) => openTelemetry.incrementCounter("addServiceAccountToGoogleGroupSuccess", tags = openTelemetryTags)
      }
  }

  override def removeMemberFromGroup(groupEmail: WorkbenchEmail, memberEmail: WorkbenchEmail): Future[Unit] = {
    super.removeMemberFromGroup(groupEmail: WorkbenchEmail, memberEmail: WorkbenchEmail)
      .andThen {
        case Failure(_) => openTelemetry.incrementCounter("removeMemberFromGoogleGroupFailure", tags = openTelemetryTags)
        case Success(_) => openTelemetry.incrementCounter("removeMemberFromGoogleGroupSuccess", tags = openTelemetryTags)
      }
  }

  override def getGoogleGroup(groupEmail: WorkbenchEmail): Future[Option[Group]] = {
    super.getGoogleGroup(groupEmail: WorkbenchEmail)
      .andThen {
  ...
  override def isGroupMember(groupEmail: WorkbenchEmail, memberEmail: WorkbenchEmail): Future[Boolean] = {
    super.isGroupMember(groupEmail: WorkbenchEmail, memberEmail: WorkbenchEmail)
      .andThen {
  ...
  override def listGroupMembers(groupEmail: WorkbenchEmail): Future[Option[Seq[String]]] = {
    super.listGroupMembers(groupEmail: WorkbenchEmail)
      .andThen {

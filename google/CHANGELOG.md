...
SBT Dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-google" % "0.35-ad2b686"`

* disables polling for service account key creation. This reverts to the 0.33 behavior.

## 0.34

SBT Dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-google" % "0.34-12ee68d"`

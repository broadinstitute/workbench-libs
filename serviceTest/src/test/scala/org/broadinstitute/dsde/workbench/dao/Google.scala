...
object Google {
  ...
  val pemMode = GoogleCredentialModes.Pem(WorkbenchEmail("101291953224627454160"), new File(ServiceTestConfig.GCS.pathToQAPem), Option(WorkbenchEmail("google@dev.test.firecloud.org")))

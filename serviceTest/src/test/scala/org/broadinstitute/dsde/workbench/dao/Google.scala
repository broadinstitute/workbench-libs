...
object Google {
  ...
  val pemMode = GoogleCredentialModes.Pem(WorkbenchEmail("109949113883754608360"), new File(ServiceTestConfig.GCS.pathToQAPem), Option(WorkbenchEmail("google@dev.test.firecloud.org")))

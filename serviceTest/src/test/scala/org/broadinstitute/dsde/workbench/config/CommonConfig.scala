...
trait CommonConfig {
  ...
  trait CommonUsers {
    ...
    private val userDataJson = JSON.parseFull(scala.io.Source.fromFile(usersConfig.getString("userDataPath")).getLines.mkString).get.asInstanceOf[Map[String, Map[String,String]]]

...
trait AuthToken extends LazyLogging {
  ...
  lazy val userLoginScopes = Seq("profile", "email", "openid") ++ billingScope
  // the list of scopes needed by service accounts to do their work:
  lazy val serviceAccountScopes = userLoginScopes ++ Seq("https://www.googleapis.com/auth/devstorage.full_control", "https://www.googleapis.com/auth/cloud-platform")

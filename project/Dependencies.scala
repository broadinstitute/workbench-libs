...
object Dependencies {
  ...
  val catsEffect: ModuleID = "org.typelevel" %% "cats-effect" % "3.3.14"
  ...
  val azureResourceManagerContainerService = "com.azure.resourcemanager" % "azure-resourcemanager-containerservice" % "2.20.0"

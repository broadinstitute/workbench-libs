...
object Dependencies {
  ...
  val googleGuava: ModuleID = "com.google.guava"  % "guava" % "31.1.2-jre"
  val googleRpc: ModuleID =               "io.grpc" % "grpc-core" % "1.56.0"
  val googleRpc2: ModuleID =               "io.grpc" % "grpc-core" % "1.56.0"
  ...
  val googlePubsubNew: ModuleID = "com.google.cloud" % "google-cloud-pubsub" % "1.123.15"
  ...
  val googleDataproc: ModuleID =    "com.google.cloud" % "google-cloud-dataproc" % "4.26.0"
  ...
  val rawlsModel: ModuleID = "org.broadinstitute.dsde" %% "rawls-model" % "0.1-97814d79a" exclude("com.typesafe.scala-logging", "scala-logging_2.13") exclude("com.typesafe.akka", "akka-stream_2.13")

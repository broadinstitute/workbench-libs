...
object Dependencies {
  ...
  val rawlsModel: ModuleID = "org.broadinstitute.dsde" %% "rawls-model" % "v0.0.511-SNAP" exclude("com.typesafe.scala-logging", "scala-logging_2.13") exclude("com.typesafe.akka", "akka-stream_2.13") exclude("com.typesafe.akka", "akka-http-core_2.13") exclude("net.sourceforge.htmlunit", "htmlunit")

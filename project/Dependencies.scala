...
object Dependencies {
  ...
  val rawlsModel: ModuleID = "org.broadinstitute.dsde" %% "rawls-model" % "339209ac" exclude("com.typesafe.scala-logging", "scala-logging_2.13") exclude("com.typesafe.akka", "akka-stream_2.13")

...
object Dependencies {
  ...
  val scalaTestMockito = "org.scalatestplus" %% "mockito-5-12" % "3.2.19.0" //Since scalatest 3.1.0, mockito support is moved to `scalatestplus`
  ...
  val byteBuddy = "net.bytebuddy" % "byte-buddy" % "1.15.11" % Test
  ...
  val rawlsModel: ModuleID = "org.broadinstitute.dsde" %% "rawls-model" % "v0.0.537-SNAP" exclude("com.typesafe.scala-logging", "scala-logging_2.13") exclude("com.typesafe.akka", "akka-stream_2.13") exclude("com.typesafe.akka", "akka-http-core_2.13") exclude("net.sourceforge.htmlunit", "htmlunit")

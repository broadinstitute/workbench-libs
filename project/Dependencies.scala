...
object Dependencies {
  ...
  val catsEffect: ModuleID = "org.typelevel" %% "cats-effect" % "3.3.8"
  ...
  val googlePubsubNew: ModuleID = "com.google.cloud" % "google-cloud-pubsub" % "1.115.5"
  ...
  val googleDataproc: ModuleID =    "com.google.cloud" % "google-cloud-dataproc" % "2.3.2"
  ...
  val googleContainerV1: ModuleID = "com.google.apis" % "google-api-services-container" % "v1-rev20220308-1.32.1"
  ...
  val fs2Io: ModuleID = "co.fs2" %% "fs2-io" % "3.2.5"

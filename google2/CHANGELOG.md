...
SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-google2" % "0.19-f0578d6"`
...
Update http4s-blaze-client, http4s-circe, ... to 0.21.15
...
Update akka-actor, akka-stream, ... to 2.6.11 (#391)

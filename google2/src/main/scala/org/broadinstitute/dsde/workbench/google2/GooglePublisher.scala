...
trait GooglePublisher[F[_]] {
  ...
  /**
   * Watch out message size quota and limitations https://cloud.google.com/pubsub/quotas This publishes a single
   * message, but the preferred approach is with streams via `publish`
   */

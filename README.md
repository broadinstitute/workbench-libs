...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-google" % "1.0-???????"`

To depend on the `MockGoogle*` classes, additionally depend on:

`"org.broadinstitute.dsde.workbench" %% "workbench-google"  % "1.0-???????" % "test" classifier "tests"`

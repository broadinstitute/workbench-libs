...
`"org.broadinstitute.dsde.workbench" %% "workbench-google"  % "0.18-38342fa" % "test" classifier "tests"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-google2" % "0.3-574da3b"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-newrelic" % "0.1-daef93a"`

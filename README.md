...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-util" % "0.3-xxxxxxx"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-google" % "0.11-7ad0aa8"`

To depend on the `MockGoogle*` classes, additionally depend on:

`"org.broadinstitute.dsde.workbench" %% "workbench-google"  % "0.11-7ad0aa8" % "test" classifier "tests"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "0.0.1-alpha-TBD" % "test" classifier "tests"`

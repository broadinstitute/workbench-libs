...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-google2" % "0.28-6bc90eb"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "3.0-TRAVIS-REPLACE-ME" % "test" classifier "tests"`

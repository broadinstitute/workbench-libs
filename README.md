...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-google2" % "0.29-TRAVIS-REPLACE-ME"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "3.0-e4c6984" % "test" classifier "tests"`

...
`"org.broadinstitute.dsde.workbench" %% "workbench-google"  % "0.15-8e9ac2a" % "test" classifier "tests"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "0.2-8e9ac2a" % "test" classifier "tests"`

...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-model" % "0.7-58a51e7"`
...
`"org.broadinstitute.dsde.workbench" %% "workbench-google"  % "0.9-xxxxxxx" % "test" classifier "tests"`

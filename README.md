...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-util" % "0.2-1b977d7"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-model" % "0.6-58a51e7"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-google" % "0.8-58a51e7"`

To depend on the `MockGoogle*` classes, additionally depend on:

`"org.broadinstitute.dsde.workbench" %% "workbench-google"  % "0.8-xxxxxxx" % "test" classifier "tests"`

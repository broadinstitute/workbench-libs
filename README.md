...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-util" % "0.6-89d0d9e"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-util2" % "0.1-89d0d9e"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "0.19-89d0d9e" % "test" classifier "tests"`

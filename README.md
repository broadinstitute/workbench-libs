...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-model" % "0.11-TRAVIS-REPLACE-ME"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "0.8-2d77c12" % "test" classifier "tests"`

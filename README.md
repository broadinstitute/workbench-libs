...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-service-test" % "4.4-TRAVIS-REPLACE-ME" % "test" classifier "tests"`
...
Latest SBT dependency: `"org.broadinstitute.dsde.workbench" %% "workbench-oauth2" % "0.7-d2b30c4"`
